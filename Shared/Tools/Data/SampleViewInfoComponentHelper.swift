                ...
                .vStack(
                    elements: [
                        .text(content: "Source Code Walkthrough of Telegram-iOS: Part 1",
                              ...
                              fontStyle: .init(size: 21, weight: .bold, color: .white)),
                        .text(content: "Overview of the Code", fontStyle: .init(size: 17, weight: .bold, color: .white)),
                        ...
                        .text(content: "**视频**:", fontStyle: .init(size: 17, color: .white)),

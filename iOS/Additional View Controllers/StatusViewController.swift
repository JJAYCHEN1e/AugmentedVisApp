...
class StatusViewController: UIViewController {
    ...
    @IBOutlet private var messagePanel: UIVisualEffectView!

    @IBOutlet private var messageLabel: UILabel!

    @IBOutlet private var restartExperienceButton: UIButton!
    ...
    @IBAction private func restartExperience(_: UIButton) {
